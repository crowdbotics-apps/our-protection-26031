"""our_protection_26031 URL Configuration
...
admin.site.site_header = "Our Protection"
admin.site.site_title = "Our Protection Admin Portal"
admin.site.index_title = "Our Protection Admin"

# swagger
api_info = openapi.Info(
    title="Our Protection API",
    default_version="v1",
    description="API documentation for Our Protection App",
)
